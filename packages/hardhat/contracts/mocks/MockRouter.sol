...
/**
 * @title MockLP
 * @notice Simple LP token for testing
 */
...
/**
 * @title MockFactory
 * @notice Simple factory for creating LP pairs
 */
contract MockFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        pair = address(new MockLPToken(token0, token1));
...
/**
 * @title MockRouter
 * @notice Simple router for testing that creates its own factory
 */
contract MockRouter {
